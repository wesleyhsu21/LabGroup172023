...
% (AERO-60001 Aerodynamics 3, supervisor: Prof. Peter Vincent)
%
%--------------------------------------------------------------------------
%
% INPUT:
...
%            For example: 
%                 2023-02-16_16-46-38_NetScannerResults1.csv 
%                 2023-02-16_16-46-38_NetScannerResults2.csv
...
% SYNTAX:
%
%           supersoniclab2023('2023-02-27_18-27-01',atm pressure, temperature)
% OUTPUT:
...
%     data files and this code (<supersoniclab.m>) are all located in the 
...
%  wall panels.
    ...
    fprintf('         (AERO-60001 Aerodynamics 3 - Prof. Peter Vincent)       \n')
    fprintf('                      (%s)\n\n',datestr(clock))
    fprintf('Call function using: [x,h,t,p0,p,xt,ts,prf] = supersoniclab2023(runtime, pe_inp, te)\n\n')

...
eqn1 = 2*A1.*q1 + 2*A2.*q2 == 222.4; %max loadiing 50 pounds
eqn2 = dtdz1 - dtdz2 == 0;
...
plot([0 g23],[0 224.4*0.30406],'r',LineWidth=1.5)
legend('Torque vs Shear Strain (Upper Surface)')
xlabel('Shear Strain')
ylabel('Torque PL')

figure(2) %Lower surface
plot([0 g76],[0 224.4*0.30406],'r',LineWidth=1.5)
legend('Torque vs Shear Strain (Lower Surface)')
xlabel('Shear Strain')
ylabel('Torque PL')

figure(3) %1-8
plot([0 g18i],[0 224.4*0.30406],'r',LineWidth=1.5)
